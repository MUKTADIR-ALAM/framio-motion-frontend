  ...
  return (
    <div className="w-11/12 mx-auto flex flex-col items-center">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
        <ServiceCard imgSrc={'https://images.pexels.com/photos/1488318/pexels-photo-1488318.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1'} serviceName="Wedding video editing"/>
